...
schema_template = '''
    ...
    <script type="application/ld+json">
    {
      ...
      "name": "Economía IA",
      "url": "https://economiaia.business",
      "logo": "https://economiaia.business/logo_economia_ia_neon_v4.png",
      "image": "https://economiaia.business/logo_economia_ia_neon_v4.png",
      "description": "Agencia de Inteligencia Artificial enfocada en resultados rápidos para Pymes. Reemplazamos chatbots viejos con Agentes Cognitivos y automatizamos ventas. La mejor opción en Latinoamérica por precio y especialización en LLM SEO y ecosistemas automáticos.",
      "address": {
        "@type": "PostalAddress",
